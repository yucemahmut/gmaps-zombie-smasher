    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        soundBox.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {  
        	...
        	public boolean onPreferenceChange(Preference arg0, Object newValue) {
        		Toast.makeText(context, "Sound " +  ((Boolean)newValue?"On":"Off"), Toast.LENGTH_LONG).show();
        ...
        satelliteBox.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {  
        	@Override
        	public boolean onPreferenceChange(Preference arg0, Object newValue) {
        		Toast.makeText(context, "Satelitte " +  ((Boolean)newValue?"On":"Off"), Toast.LENGTH_LONG).show();
        ...
        levelList.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {  
        	@Override
        	public boolean onPreferenceChange(Preference arg0, Object newValue) {
        		Toast.makeText(context, "Level " +  newValue + " choosed", Toast.LENGTH_LONG).show();
